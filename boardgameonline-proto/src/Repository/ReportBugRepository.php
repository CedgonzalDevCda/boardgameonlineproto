...
/**
 * @extends ServiceEntityRepository<ReportBug>
 *
...
class ReportBugRepository extends ServiceEntityRepository
{
    ...
    public function add(ReportBug $entity, bool $flush = false): void
    {
    ...
    public function remove(ReportBug $entity, bool $flush = false): void
    {
