...
// */
//final class Version20220518103101 extends AbstractMigration
//{
...
//        $this->addSql('ALTER TABLE game ADD category_id INT DEFAULT NULL, DROP category');
...
//        $this->addSql('ALTER TABLE game ADD category VARCHAR(50) NOT NULL, DROP category_id');
//    }
//}
